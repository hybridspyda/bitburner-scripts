...
import HWGWBaseServer from "/trhr/if.server.hwgw"
import HackableBaseServer from "/trhr/if.server.hackable"

import { numCycleForGrowthCorrected } from "/trhr/if.server.hwgw"
...
function calculate_hwgw_batch(ns, target, prep_batch=false) {
    const home = new HackableBaseServer(ns, homeServer)
    const batch_lag = 160;
